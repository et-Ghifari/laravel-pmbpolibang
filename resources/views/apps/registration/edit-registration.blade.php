                            ...
                            <form id="form_validation" method="POST">
                                    ...
                                    <div id="collapseOne_19" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne_19">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group form-float">
                                                ...
                                                <?php
                                                    '<input name="jalur" value="Beasiswa" type="radio" id="radio_1" required checked/>
                                                    <label for="radio_1"><b>BEASISWA</b></label>
                                                    <input name="jalur" value="Mandiri" type="radio" id="radio_2" required />
                                                    <label for="radio_2"><b>MANDIRI</b></label>'
                                                ?>
                                                <?php
                                                    '<input name="jalur" value="Beasiswa" type="radio" id="radio_1" required />
                                                    <label for="radio_1"><b>BEASISWA</b></label>
                                                    <input name="jalur" value="Mandiri" type="radio" id="radio_2" required checked/>
                                                    <label for="radio_2"><b>MANDIRI</b></label>'
                                                ?>
                                            </div>
                                            </div>
                                ...
                                <div class="panel panel-col-cyan">
                                    ...
                                    <div id="collapseThree_19" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingThree_19">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" class="form-control" name="nisn" placeholder="nisn" maxlength="10" minlength="10" required autocomplete="off" value=""/>
                                                </div>
                                            </div>
                                            <label>NIK*</label>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="nik" class="form-control" placeholder="nik" maxlength="16" minlength="16" required autocomplete="off" value=""/>
                                                </div>
                                            </div>
                                            <label>Nama Lengkap*</label>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="nama" class="form-control" placeholder="nama lengkap" value="" required autocomplete="off"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row clearfix">
                                                <div class="col-sm-2">
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <input type="text" name="tempat" class="form-control" placeholder="tempat" required autocomplete="off" value=""/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="anakke" class="form-control" placeholder="isi angka" autocomplete="off" value=""/>
                                                </div>
                                            </div>
                                            <label>Jumlah Saudara</label>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="saudara" class="form-control" placeholder="isi angka" autocomplete="off" value=""/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row clearfix">
                                                <div class="col-sm-2">
                                                    <div class="input-group">
                                                        <div class="form-line">
                                                            <input type="text" name="berat" class="form-control" placeholder="isi angka" autocomplete="off" value=""/>
                                                        </div>
                                            ...
                                            <div class="row clearfix">
                                                <div class="col-sm-2">
                                                    <div class="input-group">
                                                        <div class="form-line">
                                                            <input type="text" name="tinggi" class="form-control" placeholder="isi angka" autocomplete="off" value=""/>
                                                        </div>
                                                        <span class="input-group-addon">
                                                            <label>Cm</label>
                                                        </span>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="provinsi" class="form-control" placeholder="provinsi" required autocomplete="off" value=""/>
                                                </div>
                                            </div>
                                            <label>Kabupaten*</label>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="kabupaten" class="form-control" placeholder="kabupaten" required autocomplete="off" value=""/>
                                                </div>
                                            </div>
                                            <label>Kecamatan*</label>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="kecamatan" class="form-control" placeholder="kecamatan" required autocomplete="off" value=""/>
                                                </div>
                                            </div>
                                            <label>Desa*</label>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="desa" class="form-control" placeholder="desa" required autocomplete="off" value=""/>
                                                </div>
                                            </div>
                                            <label>Jl/No.Rumah/dll</label>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <textarea type="text" name="jalan" class="form-control" placeholder="Jl./No.Rumah/dll" autocomplete="off" value=""></textarea>
                                                </div>
                                            </div>
                                            <div class="row clearfix">
                                                <div class="col-sm-2">
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <input type="text" name="rt" class="form-control" placeholder="RT" required autocomplete="off" value=""/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-2">
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <input type="text" name="rw" class="form-control" placeholder="RW" required autocomplete="off" value=""/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-2">
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <input type="text" name="kodepos" class="form-control" placeholder="Kode Pos" maxlength="5" minlength="5" required autocomplete="off" value=""/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="hp" class="form-control" placeholder="handphone/wa" required autocomplete="off" value=""/>
                                                </div>
                                            </div>
                                            <label>Alamat Email*</label>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="email" class="form-control" value="" required autocomplete="off" value=""/>
                                                </div>
                                            </div>
                                            <label>Asal Sekolah*</label>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="asalSekolah" class="form-control" placeholder="asal sekolah" required autocomplete="off" value=""/>
                                                </div>
                                            </div>
                                            <label>No. SKHUN</label>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="skhun" class="form-control" placeholder="no. skhun" autocomplete="off" value=""/>
                                                </div>
                                            </div>
                                ...
                                <div class="panel panel-col-cyan">
                                    ...
                                    <div id="collapseFour_19" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingFour_19">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="kkAyah" class="form-control" placeholder="nomor kk" maxlength="16" minlength="16" required autocomplete="off" value=""/>
                                                </div>
                                            </div>
                                            <br></br>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="nikAyah" class="form-control" placeholder="nik ayah" maxlength="16" minlength="16" required autocomplete="off" value=""/>
                                                </div>
                                            </div>
                                            <label>Nama Ayah*</label>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="ayah" class="form-control" placeholder="nama ayah" required autocomplete="off" value=""/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="nikIbu" class="form-control" placeholder="nik ibu" maxlength="16" minlength="16" required autocomplete="off" value=""/>
                                                </div>
                                            </div>
                                            <label>Nama Ibu*</label>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="ibu" class="form-control" placeholder="nama ibu" required autocomplete="off" value=""/>
                                                </div>
                                            </div>
                                ...
                                <div class="panel panel-col-cyan">
                                    ...
                                    <div id="collapseFive_19" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingFive_19">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="lomba" class="form-control" placeholder="cabang lomba" autocomplete="off" value=""/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="tahun" class="form-control" placeholder="tahun lomba" autocomplete="off" value=""/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel panel-col-cyan">
                                        ...
                                        <div id="collapseSeven_19" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingSix_19">
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                        <input type="text" name="sumber" class="form-control" value="" autocomplete="off"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row clearfix">
                                    <div class="button-demo" align="center">
                                        <button type="submit" class="btn bg-green m-t-15 waves-effect" name="editFormulir">
