                        ...
                        <div class="table">
                            <table class="table table-bordered table-striped table-hover js-basic-example">
                                ...
                                <tbody>
                                    <tr>
                                        <td>PMB202300001</td>
                                        <td>SALSA SAFIRA RUHMA</td>
                                        <td>MANDIRI</td>
                                        <td>salsasafiraruhma@gmail.com</td>

                                        <td class="align-center"><a href="{{ asset ('images/file.png') }}" target="_blank">Bukti Pembayaran</a></td>
                                        <td>
                                            <div class="demo-switch">
                                                <div class="switch">
                                                    <label>BELUM<input type="checkbox" ><span class="lever" ></span>SELESAI</label>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="align-center">
                                            <a href="viewConfirm.php?id=1" class="btn bg-cyan waves-effect" data-toggle="tooltip" data-placement="left" title="Review"><i class="material-icons">visibility</i></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
