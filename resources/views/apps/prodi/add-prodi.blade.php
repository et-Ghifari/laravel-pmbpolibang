    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>Tambah Menu Prodi</h2>
                    </div>
                    <div class="body">
                        <form id="form_validation" action="{{ route ('prodi.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="body">
                                <div class="row">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <textarea rows="4" type="text" class="form-control no-resize" name="keterangan" placeholder="keterangan" required autocomplete="off" required></textarea>
                                        </div>
                                    </div>
                                    <label>Hastag</label>
                                    <div class="form-group form-float">
