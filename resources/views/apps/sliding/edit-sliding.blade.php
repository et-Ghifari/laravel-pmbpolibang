    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>Ubah Sliding Image</h2>
                    </div>
                    <div class="body">
                        <form id="form_validation" action="{{ route ('sliding.update', $sliding) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="body">
                                <div class="row">
                                    <div class="form-group form-float">
                                        ...
                                        <img id="buktiDisplay" onclick="buktiClick()" src="{{ !empty($sliding->foto) ? asset ('storage/sliding/'.$sliding->foto) : asset ('images/file.png') }}" class="img-responsive">
